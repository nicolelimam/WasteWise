...
--
-- Host: localhost
-- Tempo de geração: 05/12/2023 às 00:54
...
(72, 'Lua Carla Silva', 'luac@gmail.com', '$2y$10$4jJALT/F9je8b91EO4r.oO2W5AXnO6VcAy6Ca3eYAZX/AOnM4StWG', 2),
...
(75, 'Maria Cristina', 'mariac@gmail.com', '$2y$10$P5TcAY3Rx/ZhtfLjtcuwa.L3rKO0N1IWoMPpAs.YuhgPY7GxFLSvy', 1),
(76, 'Nadia Borges', 'nadia@gmail.com', '$2y$10$sG4h2yL5Fpp/HxJZfHqOF.44PXoOReU/3eHG.2av9bAhYyydWU5Ue', 2),
(78, 'Nicole Junior', 'nicolej@gmail.com', '$2y$10$zqM9p/sn/BLUcjSt7I1xRuz13V0KUteOxft6JsGDIH1GYQGtYHa6W', 2);
...
(6, 'Rua Antonio Pinto', 'Cruzeiro', 'SP', 72),
(7, 'Rua Lalala', 'Alalala', 'SP', 76),
(8, 'Rua aloisio orlando', 'cruzeiro', 'sao paulo', 78);
...
(7, '2023-12-04 12:10:10', 72, 'LKOS192jsIDB874', 55),
(8, '2023-12-04 12:12:34', 76, 'LKOS192jsIDB874', 55),
(9, '2023-12-04 13:49:34', 78, 'LKOS192jsIDB874', 55);
...
(2, 72, 'LKOS192jsIDB874', 1),
(3, 72, 'LKOS192jsIDB874', 1),
(4, 72, 'OKATK912js65SAW', 1),
(5, 74, 'LKOS192jsIDB874', 1),
(6, 72, 'LKOS192jsIDB874', 1),
(7, 72, 'LKOS192jsIDB874', 1),
(8, 76, 'LKOS192jsIDB874', 2),
(9, 78, 'LKOS192jsIDB874', 2);
...
--
ALTER TABLE `ClienteCep`
  MODIFY `idClienteCep` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `DadosArduino`
  MODIFY `idDadosArd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `MinhasLixeiras`
  MODIFY `idMinhasLixeiras` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
